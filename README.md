...
1. Download `termide-0.29.0-x86_64-pc-windows-msvc.zip` from [GitHub Releases](https://github.com/termide/termide/releases).
...
Alternatively, in **WSL/WSL2** use the Linux x86_64 build (`termide-0.29.0-x86_64-unknown-linux-gnu.tar.gz`) as on any Linux.

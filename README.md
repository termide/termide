...
wget https://github.com/termide/termide/releases/latest/download/termide-0.29.7-x86_64-unknown-linux-gnu.tar.gz
tar xzf termide-0.29.7-x86_64-unknown-linux-gnu.tar.gz
./termide

# Linux x86_64 (static musl — Alpine, distroless containers, any glibc-free system)
wget https://github.com/termide/termide/releases/latest/download/termide-0.29.7-x86_64-unknown-linux-musl.tar.gz
tar xzf termide-0.29.7-x86_64-unknown-linux-musl.tar.gz
./termide

# macOS Intel (x86_64)
curl -LO https://github.com/termide/termide/releases/latest/download/termide-0.29.7-x86_64-apple-darwin.tar.gz
tar xzf termide-0.29.7-x86_64-apple-darwin.tar.gz
./termide

# macOS Apple Silicon (ARM64)
curl -LO https://github.com/termide/termide/releases/latest/download/termide-0.29.7-aarch64-apple-darwin.tar.gz
tar xzf termide-0.29.7-aarch64-apple-darwin.tar.gz
./termide

# Linux ARM64 (Raspberry Pi, ARM servers)
wget https://github.com/termide/termide/releases/latest/download/termide-0.29.7-aarch64-unknown-linux-gnu.tar.gz
tar xzf termide-0.29.7-aarch64-unknown-linux-gnu.tar.gz
./termide

# Linux ARM64 (static musl — Android/Termux, Alpine ARM, any glibc-free ARM64)
wget https://github.com/termide/termide/releases/latest/download/termide-0.29.7-aarch64-unknown-linux-musl.tar.gz
tar xzf termide-0.29.7-aarch64-unknown-linux-musl.tar.gz
./termide

# Windows x86_64 (download .zip from Releases, extract, run in Windows Terminal)
# https://github.com/termide/termide/releases/latest/download/termide-0.29.7-x86_64-pc-windows-msvc.zip
```
...
1. Download `termide-0.29.7-x86_64-pc-windows-msvc.zip` from [GitHub Releases](https://github.com/termide/termide/releases).
...
Alternatively, in **WSL/WSL2** use the Linux x86_64 build (`termide-0.29.7-x86_64-unknown-linux-gnu.tar.gz`) as on any Linux.
...
wget https://github.com/termide/termide/releases/latest/download/termide_0.29.7-1_amd64.deb
sudo dpkg -i termide_0.29.7-1_amd64.deb
```
...
```bash
# x86_64 only (ARM64 use tar.gz above)
wget https://github.com/termide/termide/releases/latest/download/termide-0.29.7-1.x86_64.rpm
sudo rpm -i termide-0.29.7-1.x86_64.rpm
```

...
1. 从 [GitHub Releases](https://github.com/termide/termide/releases) 下载 `termide-0.29.5-x86_64-pc-windows-msvc.zip`。
2. 解压压缩包。
...
（`termide-0.29.5-x86_64-unknown-linux-gnu.tar.gz`）。

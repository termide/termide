...
pub use cache::{HighlightCache, LineHighlighter, WHOLE_DOCUMENT_BYTE_LIMIT};
pub use keyword::KeywordSyntax;
pub use languages::{detect_language, HIGHLIGHT_NAMES, SUPPORTED_LANGUAGES};

use languages::KOTLIN_HIGHLIGHTS;

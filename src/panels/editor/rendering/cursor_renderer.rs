...
pub fn render_cursor_at(buf: &mut Buffer, x: u16, y: u16, area: Rect, theme: &crate::theme::Theme) {
...
fn invert_cell_colors(cell: &mut ratatui::buffer::Cell, theme: &crate::theme::Theme) {

...
1. Скачайте `termide-0.29.2-x86_64-pc-windows-msvc.zip` с [GitHub Releases](https://github.com/termide/termide/releases).
2. Распакуйте архив.
...
Либо в **WSL/WSL2** используйте сборку Linux x86_64 (`termide-0.29.2-x86_64-unknown-linux-gnu.tar.gz`), как на любом Linux.
